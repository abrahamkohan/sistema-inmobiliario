...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'proyectos',              element: <RequirePermiso modulo="proyectos" fallback={<Navigate to="/inicio" replace />}><ProyectosPage /></RequirePermiso> },
      { path: 'proyectos/nueva',        element: <RequirePermiso modulo="proyectos" fallback={<Navigate to="/inicio" replace />}><ProyectoFormPage /></RequirePermiso> },
      { path: 'proyectos/:id',          element: <RequirePermiso modulo="proyectos" fallback={<Navigate to="/inicio" replace />}><ProjectDetailPage /></RequirePermiso> },
      { path: 'proyectos/:id/editar',   element: <RequirePermiso modulo="proyectos" fallback={<Navigate to="/inicio" replace />}><ProyectoFormPage /></RequirePermiso> },
      { path: 'clientes', element: <RequirePermiso modulo="crm" fallback={<Navigate to="/inicio" replace />}><ClientesPage /></RequirePermiso> },
      { path: 'clientes/nuevo', element: <RequirePermiso modulo="crm" fallback={<Navigate to="/inicio" replace />}><ClienteFormPage /></RequirePermiso> },
      { path: 'clientes/:id', element: <RequirePermiso modulo="crm" fallback={<Navigate to="/inicio" replace />}><ClientDetailPage /></RequirePermiso> },
      { path: 'clientes/:id/editar', element: <RequirePermiso modulo="crm" fallback={<Navigate to="/inicio" replace />}><ClienteFormPage /></RequirePermiso> },
      ...
      { path: 'propiedades',        element: <RequirePermiso modulo="propiedades" fallback={<Navigate to="/inicio" replace />}><PropiedadesPage /></RequirePermiso> },
      { path: 'propiedades/nueva',  element: <RequirePermiso modulo="propiedades" fallback={<Navigate to="/inicio" replace />}><PropiedadNuevaPage /></RequirePermiso> },
      { path: 'propiedades/:id',         element: <RequirePermiso modulo="propiedades" fallback={<Navigate to="/inicio" replace />}><PropiedadDetallePage /></RequirePermiso> },
      { path: 'propiedades/:id/editar', element: <RequirePermiso modulo="propiedades" fallback={<Navigate to="/inicio" replace />}><PropiedadEditarPage /></RequirePermiso> },
      { path: 'tareas',        element: <TareasPage /> },
      { path: 'notas',         element: <NotasPage /> },
      { path: 'marketing',     element: <RequirePermiso modulo="marketing" fallback={<Navigate to="/inicio" replace />}><MarketingPage /></RequirePermiso> },
